...
var contenedorNav = document.querySelector("#nav");
var inputBuscar = document.querySelector("#buscar");
var menu = document.querySelector(".menuSmall");
var iconBars = document.querySelector(".bars");
var iconHome = document.querySelector("#home");
var starSearch = document.querySelector("#starSearch"); //BARS
